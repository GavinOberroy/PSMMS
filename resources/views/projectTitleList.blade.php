    ...
    <div class="app-container">
        ...
        <div class="app-content">
            <div class="app-sidebar">
                ...
                <a href="supervisor" class="app-sidebar-link">
                ...
                <a href="viewTitle" class="app-sidebar-link active">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="projects-section">
                ...
                <div id=supervisorList class="project-boxes jsListView">

                    @foreach($supervisors as $supervisor)
                    <a style="text-decoration:none; color: black;" onclick="myFunction()">
                        <div class="project-box-wrapper">
                            <div class="project-box" style="background-color: #dbf6fd;">
                                <div class="project-box-content-header" style="display: flex; ">
                                    <img src="data:image/jpg;base64,{{ chunk_split(base64_encode($supervisor->img)) }}"
                                        style="border-radius: 10px; object-fit: cover;" height="50px" width="50px" />
