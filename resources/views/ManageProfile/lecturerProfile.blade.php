            ...
            <div class="projects-section">
                ...
                <div class="projects-section-line">
                    ...
                    <div class="tab">
                        ...
                        <a class="tablinks" href="{{url('lecturerExpertise/{$lecturer->Lecturer_ID}')}}">Expertise</a>
                    </div>
                </div>
                ...
                <div style="display: none; grid-template-columns: auto;" class="grid-content" id="expertise">
                    ...
                    overflow-y: auto;">
                        ...
                        <div class="project-box-wrapper">
                            ...
                            <div class="menu effect-12" style="width:100px;">
                                <ul>
                                ...
                                <div class="project-box-wrapper">
                                    <div class="project-box" style="background-color: #ABC3C9;">
                                        ...
                                        <div class="grid-child">
                                            ...
                                            <div class="menu effect-12" style="padding-bottom: 5px;width:100px;">        
                                                <ul>
