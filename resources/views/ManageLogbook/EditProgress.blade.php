...
<!-- ADD FORM -->
<br>
<form method="post" action="/updateProgress/{{$logbooks->Logbook_ID}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="box-content-subheader">
                             ...
                             <div class="input--style-5">
                                 <input name="Logbook_Week" type="text" class="form-control" style="height: 30px; width:1000px;" value="{{$logbooks->Logbook_Week}}" required>
                             </div>
                        </div>
                        <br>
                        <div class="box-content-subheader">
                             ...
                             <div class="input--style-5">
                                 <input name="Logbook_Date" type="text" class="form-control" style="height: 30px; width:1000px;"  value="{{$logbooks->Logbook_Date}}" required>
                             </div>
                        </div>
                        <br>
                        <div class="box-content-subheader">
                             ...
                             <div class="input--style-5">
                                 <input name="Logbook_Time" type="text" class="form-control" style="height: 30px; width:1000px;" value="{{$logbooks->Logbook_Time}}" required>
                             </div>
                        </div>
                        <br>
                        <div class="box-content-subheader">
                            ...
                            <div class="input--style-5">
                            <input name="Current_Progress" type="text" class="form-control" style="height: 100px; width:100%;" value="{{$logbooks->Current_Progress}}" required>
                        </div>
                        <br>
                        <div class="box-content-subheader">
                            <label for="Upcoming_Progress" class="col-sm-3 col-form-label"><b>UPCOMING PROGRESS :</b></label>
                            <div class="input--style-5">
                            <input name="Upcoming_Progress" type="text" class="form-control" style="height: 100px; width:100%;" value="{{$logbooks->Upcoming_Progress}}" required>
                        </div>
                        <br>
                        <div class="form-group row">
                            <div class="offset-sm-3 col-sm-9">
                            <button type="submit" class="btn btn-primary m-2" >EDIT LOGBOOK </button>
